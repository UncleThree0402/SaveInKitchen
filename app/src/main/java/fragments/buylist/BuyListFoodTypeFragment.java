...
public class BuyListFoodTypeFragment extends Fragment implements View.OnClickListener{
    ...
    private void validName() {
        ...
        if (name.isEmpty()) {
            ...
            BuyListAddFoodFragment addStockAddFoodFragment = new BuyListAddFoodFragment();
